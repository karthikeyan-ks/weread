        ...
        <div className='w-screen h-screen bg-gray-200'>
            <form className='w-screen h-[50%] sm:p-10 flex flex-row justify-center items-center'>
                ...
                <fieldset className="border p-4 w-[90%] sm:w-[50%]">
                    <h1 className='font-custom text-black sm:text-h1 text-h1mobile text-center' >Admin Panel</h1>
                    <br />
                    <br />
                    <div className='border border-black p-3 shadow-sm p-6 rounded-px-10'>
                        ...
                        <button onClick={() => {
                            navigate('/dashboard')
                        }} className=" bg-blue-500 text-black py-2 px-4 rounded-lg hover:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            login
                        </button>
                    </div>
                </fieldset>
